...
with open(r'C:\Users\gaura\Desktop\Github\Stoke classification and prediction model\xgb_model.pkl', 'rb') as file:
    model = pickle.load(file)

# Load the saved scaler
with open(r'C:\Users\gaura\Desktop\Github\Stoke classification and prediction model\scaler.pkl', 'rb') as file:
    scaler = pickle.load(file)

# Load the saved columns
with open(r'C:\Users\gaura\Desktop\Github\Stoke classification and prediction model\columns.pkl', 'rb') as file:
